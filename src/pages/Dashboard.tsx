...
import { Calendar, User, MapPin, LogOut, Plus } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg">
          ...
          <button
            ...
            className="mt-6 w-full flex items-center justify-center space-x-2 bg-orange-600 text-white px-4 py-2 rounded-lg hover:bg-orange-700 transition-colors mb-3"
          >
            <Plus className="w-4 h-4" />
            <span>Book New Pooja</span>
          </button>
          <button
